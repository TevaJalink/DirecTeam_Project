...
while True:
    ...
    if 'Messages' in response:
        ...
        # line 17-19 is responsible for updating the csv to s3 bucket using boto3 library
        try:
        ...
        # we would want to let the message back to the queue to be proccessed again
